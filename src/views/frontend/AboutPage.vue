      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto mb-5 mb-lg-0">
            <h1 class="mb-4">Partho Saroti Kar</h1>
            <div class="content">
              <p>
                Hello, I&rsquo;m Hootan Safiyari. A Content writter, Developer
                and Story teller. Working as a Content writter at CoolTech
                Agency. Quam nihil enim maxime corporis cumque totam aliquid nam
                sint inventore optio modi neque laborum officiis necessitatibus,
